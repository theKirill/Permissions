...
class MainActivity : AppCompatActivity() {
    ...
    val REQUEST_CODE_PERMISSION_LOCATION: Int = 1;
    ...
    fun buttonStartMyAppClick(v: View) {
        myIntent = packageManager.getLaunchIntentForPackage("com.yanyushkin.ex1.tasks2")
    ...
    fun locationOnClick(v: View) {
        var permissionStatus = ContextCompat.checkSelfPermission(this, android.Manifest.permission.ACCESS_FINE_LOCATION)
